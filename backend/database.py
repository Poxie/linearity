...
class Database():
    ...
    def __create_connection(self) -> MySQLConnectionPool:
        try:
            ...
            cursor.execute('CREATE TABLE IF NOT EXISTS invitations (sender_id BIGINT(20), team_id BIGINT(20), user_id BIGINT(20), role VARCHAR(255), created_at BIGINT(20), updated_at BIGINT(20) DEFAULT NULL)')
            ...
            cursor.execute('CREATE TABLE IF NOT EXISTS tasks (id BIGINT(20), team_id BIGINT(20), group_id BIGINT(20), title VARCHAR(255), description TEXT DEFAULT NULL, position BIGINT(20), created_at BIGINT(20), due_at BIGINT(20) DEFAULT NULL)')
